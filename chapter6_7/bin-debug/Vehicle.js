...
var Vehicle = (function (_super) {
    ...
    */
    ...
    Vehicle.prototype.cohesion = function (vehicles) {
        var neighVehiclesDist = 80;
        var sum = new Vector2D(0, 0);
        var count = 0;
        for (var _i = 0, vehicles_3 = vehicles; _i < vehicles_3.length; _i++) {
            var other = vehicles_3[_i];
            var d = Vector2D.dist(this.location, other.location);
            if (d > 0 && d < neighVehiclesDist) {
    ...
    Vehicle.prototype.flock = function (vehicles) {
        ...
        var coh = this.cohesion(vehicles);
        separate.mult(3);
        align.mult(1);
        coh.mult(1);
